...
//            ]), null, '&');
            $query = 'USER_LOGIN='.$this->parameters->getAuth('login').'&'.'USER_HASH='.$this->parameters->getAuth('apikey');
        } else {
//            $query = http_build_query(array_merge($this->parameters->getGet(), [
//                'login' => $this->parameters->getAuth('login'),
//                'api_key' => $this->parameters->getAuth('apikey'),
//            ]), null, '&');
            $query = 'login='.$this->parameters->getAuth('login').'&'.'api_key='.$this->parameters->getAuth('apikey');
        }
